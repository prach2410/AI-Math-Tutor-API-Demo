...
public static class KnowledgeCurriculum
{
    ...
    [
        new CurriculumTopic(
            ...
            PassiveGrill:
                "ลองนึกถึงความต่างระหว่าง \"ตอบ\" กับ \"สอน\" นะคะ\n\n" +
                "Google ตอบทุกคำถามได้ทันที — แต่ทำไมคนยังต้องมีครู?\n\n" +
                "เพราะการได้รับคำตอบ ≠ การเข้าใจ\n" +
                "ครูที่ดีไม่ใช่คนที่มีคำตอบมากที่สุด\n" +
                "แต่คือคนที่รู้ว่า เมื่อไหร่ควรถาม เมื่อไหร่ควรรอ และเมื่อไหร่ถึงจะตอบ\n\n" +
                "นั่นคือสิ่งที่ Teaching Flow ทำ\n" +
                "และนั่นคือเหตุผลที่ Teaching Flow > AI Capability"
        ),
        ...
        new CurriculumTopic(
            ...
            PassiveGrill:
                "ลองนึกภาพนักเรียนสองคนนะคะ\n\n" +
                "คนแรก: ท่อง \"7×8=56\" ขึ้นใจ ทำข้อสอบผ่านทุกข้อ\n" +
                "คนที่สอง: คำนวณช้า แต่อธิบายได้ว่า \"เพราะเรียงของ 7 แถว แถวละ 8 ชิ้น ก็ได้ 56\"\n\n" +
                "ถามว่า \"ถ้าของ 56 ชิ้น แบ่งให้ 8 คนเท่าๆ กัน แต่ละคนได้กี่ชิ้น?\"\n" +
                "คนแรกมักสับสน — เพราะจำสูตร แต่ไม่เข้าใจความหมาย\n" +
                "คนที่สองตอบได้ทันที — เพราะเข้าใจว่าการคูณกับการหารเป็นการนับในทิศทางต่างกัน\n\n" +
                "นั่นคือความต่างระหว่าง Correct Answer กับ Understanding"
        ),
        ...
        new CurriculumTopic(
            ...
            PassiveGrill:
                "ลองนึกถึงครูสองคนที่มีความรู้เท่ากันทุกอย่างนะคะ\n\n" +
                "ครูคนแรกมี lesson plan: อธิบาย → ตรวจว่าเข้าใจ → ให้ตัวอย่าง → รอให้ลองเอง → feedback\n" +
                "ครูคนที่สอง improvise: ตอบทุกคำถามของนักเรียนทันที อย่างละเอียด ไม่ว่าจะถามอะไร\n\n" +
                "หลัง 1 ชั่วโมง นักเรียนของครูคนแรกอธิบายสิ่งที่เรียนเองได้\n" +
                "นักเรียนของครูคนที่สองรู้สึกว่าได้ยินเยอะมาก แต่ยังอธิบายเองไม่ได้\n\n" +
                "ความต่างไม่ได้อยู่ที่ความรู้ — อยู่ที่โครงสร้าง\n" +
                "Learning Flow Engine คือ lesson plan นั้น LLM คือเสียงของครู"
        ),
        ...
        new CurriculumTopic(
            ...
            PassiveGrill:
                "Discovery ไม่ได้เกิดจากการนั่งคิดคนเดียวนะคะ\n\n" +
                "ทุก Discovery ในโปรเจกต์นี้เกิดขึ้นในช่วงเวลาที่\n" +
                "\"ระบบทำในสิ่งที่เราคาดหวัง — แต่ผลลัพธ์ไม่ใช่สิ่งที่ต้องการ\"\n\n" +
                "เช่น D003: เราคิดว่าหลังสอนจบ ผู้ใช้พร้อมถูก Grill ทันที\n" +
                "แต่ผู้ใช้จริงบอกว่า \"ยังไม่เข้าใจเลย แล้วมาเจอคำถามอีก\"\n" +
                "→ นั่นคือ Discovery ที่นำไปสู่ Comprehension Check Stage\n\n" +
                "Discovery ไม่ได้ถูก \"วางแผน\" — มันถูก \"สังเกตเห็น\" จากสิ่งที่เกิดขึ้นจริง"
        ),
        ...
        new CurriculumTopic(
            ...
            PassiveGrill:
                "ทุก decision ที่ถูก \"ปิด\" มีคุณค่าที่มองไม่เห็นนะคะ\n\n" +
                "มันปกป้องทีมจากการ debate เรื่องเดิมซ้ำๆ ทุกสัปดาห์\n\n" +
                "ต้นทุนของการ re-debate ไม่ใช่แค่เวลา — มันทำให้\n" +
                "ทีมหยุดเชื่อว่า decision จะอยู่ได้\n" +
                "คนเริ่ม implement แบบ \"รอก่อน เผื่อเปลี่ยน\"\n" +
                "Momentum หายไปเงียบๆ\n\n" +
                "เมื่อรู้ว่า \"ทำไม\" ถึงตัดสินใจแบบนั้น\n" +
                "คุณจะรู้ว่าเมื่อไหร่ควรเปิด decision ใหม่ (มีหลักฐานใหม่) และเมื่อไหร่ควรเดินหน้าต่อ"
        ),
    ];
