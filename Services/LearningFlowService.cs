...
public class LearningFlowService
{
    ...
    public EvaluateResponse Evaluate(EvaluateRequest request)
    {
        ...
        if (!correct)
        {
            return new EvaluateResponse(
                Correct: false,
                Message: $"ลองตรวจดูอีกครั้งนะ {n} 💭 คิดทีละขั้น — เริ่มจากตัวเลขไหนก่อนดีครับ?",
                Hint: step.Hint,
                NextStep: null,
                StudentNote: null,
                ParentSummary: null,
        ...
        var teachingMoment = step.TeachingMoment is not null ? $"\n\n{step.TeachingMoment}" : "";
        return new EvaluateResponse(
            Correct: true,
            Message: $"เยี่ยมมากเลย {n}! 🎉{teachingMoment}",
            Hint: null,
            NextStep: new NextStepDto(next.StepNumber, step.TotalSteps, next.Question, next.IsLast, next.PassiveGrill),
            StudentNote: null,
            ParentSummary: null,
            IsGuidedAssistance: false,
            LearningReflection: null,
            TeachingMomentType: step.TechniqueType
        );
    }
    ...
    [
        new ScenarioDefinition(
            ...
            [
                new(1, 4,
                    Question: "ก่อนคำนวณ ลองนึกภาพก่อนนะครับ 🎯\n\nถ้าเราเอาลูกบาศก์เล็กๆ มาเรียงเต็มตู้ปลา — เราจะนับ 'จำนวนลูกบาศก์ทั้งหมด' ยังไง?\n\nนั่นคือความหมายของ 'ปริมาตร' ครับ\nแล้วสูตรคำนวณปริมาตรทรงสี่เหลี่ยมมุมฉากคืออะไรครับ?",
                    ExpectedAnswer: "กว้างxยาวxสูง",
                    Hint: "ลองนึกถึงการหาพื้นที่ฐาน แล้วคูณความสูงครับ",
                    GuidedAssistance: "ไม่เป็นไรเลย! 💪 มาเริ่มด้วยกันนะครับ\n\nลองนึกภาพนี้: ถ้าเราวางลูกบาศก์ 1 ซม. เรียงตามความกว้าง ยาว และสูง\n• แถวแรก = กว้าง × ยาว ลูกบาศก์\n• ทุกชั้นรวมกัน = กว้าง × ยาว × สูง\n\nนั่นคือสูตรปริมาตรครับ!\nลองเขียนสูตรดูครับ: กว้าง × ? × ?",
                    WorkedExample: "ตัวอย่างการหาปริมาตร\n\nปริมาตร\n  = กว้าง × ยาว × สูง\n  = 20 × 40 × 30\n  = 24,000 ลบ.ซม.\n\nลองพิมพ์สูตรให้ถูกต้องดูครับ",
                    IsLast: false,
                    PassiveGrill: "🧠 ก่อนทำโจทย์ — ลองนึกภาพนี้ก่อนนะครับ\n\nเวลาเราเทน้ำเต็มแก้ว สิ่งที่เราวัดไม่ใช่ขนาดของแก้ว — แต่คือ space ข้างในที่น้ำเข้าไปได้\n\nปริมาตรก็คือ space ข้างในนั้น\nถ้าเรียงลูกบาศก์เล็กๆ เต็มตู้ปลา เราแค่นับว่า 'ข้างในจุได้กี่ลูก' — นั่นแหละคือปริมาตรครับ"),
                new(2, 4,
                    ...
                    IsLast: false,
                    TeachingMoment: "🎯 เทคนิคคิดเร็ว: เวลาคูณเลขที่ลงท้ายด้วยศูนย์ ให้คูณตัวเลขหลักก่อน (2×4=8) แล้วนับศูนย์ทั้งหมดแล้วเติมตามครับ",
                    TechniqueType: "mental_math",
                    PassiveGrill: "🧠 ก่อนทำโจทย์ — ลองนึกภาพนี้ก่อนนะครับ\n\n20 × 40 จริงๆ แล้วคือการนับว่า ถ้าเรียงลูกบาศก์ 20 ตัวต่อแถว มี 40 แถว จะได้กี่ตัวทั้งหมด?\n\nไม่ต่างจากการนับช่องในตาราง 20 คอลัมน์ × 40 แถวเลยครับ"),
                new(3, 4,
                    ...
                    IsLast: false,
                    TeachingMoment: "🎯 เห็นรูปแบบเดิมไหมครับ — 8×3=24 แล้วนับศูนย์รวม 3 ตัว = 24,000\nเทคนิคนี้ใช้ได้กับทุกการคูณเลขกลมๆ เลยครับ!",
                    TechniqueType: "pattern_recognition",
                    PassiveGrill: "🧠 ก่อนทำโจทย์ — สังเกตรูปแบบนี้ก่อนนะครับ\n\nเราทำเหมือนเดิมซ้ำอีกครั้ง — คูณตัวเลขหลักก่อน แล้วนับศูนย์\n\nคณิตศาสตร์ชอบรูปแบบซ้ำๆ แบบนี้\nยิ่งสังเกตรูปแบบได้เร็ว ยิ่งคำนวณเร็วขึ้นเรื่อยๆ ครับ"),
                new(4, 4,
                    ...
                    IsLast: true,
                    PassiveGrill: "🧠 ก่อนทำโจทย์ — ลองนึกภาพนี้ก่อนนะครับ\n\n1 ลิตร = 1,000 ลบ.ซม. เสมอ\nนึกถึงขวดน้ำ 1 ลิตร — ถ้าทำให้เป็นลูกบาศก์ มันจะมีขนาดแค่ 10×10×10 ซม. พอดี\n\nแปลว่า ลบ.ซม. คือหน่วยเล็ก ลิตรคือหน่วยใหญ่กว่า 1,000 เท่าครับ"),
            ]
        ),
        ...
        new ScenarioDefinition(
            ...
            [
                new(1, 4,
                    Question: "ก่อนคำนวณ ลองคิดภาพก่อนนะครับ 🎯\n\nถ้าเราต้องห่อกระดาษรอบกล่องพัสดุทุกด้าน — กล่องมีกี่หน้า? และหน้าเหล่านั้นจับคู่กันได้ยังไง?\n\nนั่นคือความหมายของ 'พื้นที่ผิว' ครับ\nแล้วสูตรคำนวณพื้นที่ผิวทรงสี่เหลี่ยมมุมฉากคืออะไรครับ?",
                    ExpectedAnswer: "2(กว้างxยาว+กว้างxสูง+ยาวxสูง)",
                    Hint: "กล่องมี 6 หน้า แบ่งเป็น 3 คู่ครับ",
                    GuidedAssistance: "ไม่เป็นไรเลยครับ! 💪 มาดูด้วยกันนะครับ\n\nลองนึกภาพห่อกระดาษ — กล่องมี 6 หน้า จับคู่เป็น 3 คู่:\n• บน+ล่าง = 2(กว้าง×ยาว)\n• หน้า+หลัง = 2(กว้าง×สูง)\n• ซ้าย+ขวา = 2(ยาว×สูง)\n\nรวมทั้งหมด = 2(กว้าง×ยาว + กว้าง×สูง + ยาว×สูง)\n\nลองพิมพ์สูตรนี้ดูครับ",
                    WorkedExample: "ตัวอย่างการหาพื้นที่ผิว\n\nพื้นที่ผิว\n  = (20×30×2)\n  + (20×10×2)\n  + (30×10×2)\n  = 1,200 + 400 + 600\n  = 2,200 ตร.ซม.\n\nลองพิมพ์สูตรทั่วไปดูครับ",
                    IsLast: false,
                    PassiveGrill: "🧠 ก่อนทำโจทย์ — ลองนึกภาพนี้ก่อนนะครับ\n\nเวลาห่อของขวัญ เราต้องใช้กระดาษปิดทุกด้านของกล่อง ไม่ใช่แค่ด้านบน\n\nกล่องมี 6 หน้า แต่จับคู่ได้เป็น 3 คู่ที่เหมือนกัน — นั่นคือที่มาของ '2(...)' ในสูตรครับ"),
                new(2, 4,
                    ...
                    WorkedExample: "วิธีคูณ 20 × 30\n\n2 × 3 = 6\nเติมศูนย์อีก 2 ตัว\n= 600\n\nมาลองด้วยกันก่อนนะครับ\n20 × 30 = 600\nลองทำขั้นถัดไปดูครับ",
                    IsLast: false,
                    TeachingMoment: "🎯 เทคนิคคิดเร็ว: คูณตัวเลขหลักก่อน (2×3=6) แล้วเติมศูนย์ตามจำนวนที่มีครับ\nเทคนิคนี้จะใช้ซ้ำในทุกขั้นตอนเลยครับ!",
                    TechniqueType: "mental_math",
                    PassiveGrill: "🧠 ก่อนทำโจทย์ — ลองนึกภาพนี้ก่อนนะครับ\n\n20×30 คือพื้นที่ของหน้าบนและหน้าล่างของกล่อง — ลองนึกถึงแผ่นกระดาษที่ต้องปิดตรงนั้น\n\nหน้าบนกับหน้าล่างเหมือนกันทุกอย่าง เลยนับครั้งเดียวแล้วคูณ 2 ทีหลังครับ"),
                new(3, 4,
                    ...
                    IsLast: false,
                    TeachingMoment: "💡 เทคนิคบวกหลายตัว: หาคู่ที่บวกง่ายก่อน แล้วค่อยบวกตัวที่เหลือ\nแทนที่จะบวกซ้ายไปขวา ลองดูว่าคู่ไหนรวมกันได้ตัวเลขกลมๆ ก่อนครับ",
                    TechniqueType: "simplification",
                    PassiveGrill: "🧠 ก่อนทำโจทย์ — ลองเปรียบเทียบนี้ก่อนนะครับ\n\nปริมาตร ใช้ × สามตัวเลข\nพื้นที่ผิว ใช้ + สามกลุ่ม\n\nคนละมิติ คนละวิธีคิด — แต่ทั้งสองอธิบาย shape เดียวกันครับ"),
                new(4, 4,
                    ...
                    IsLast: true,
                    PassiveGrill: "🧠 ก่อนทำโจทย์ — ลองนึกถึงเหตุผลนี้ก่อนนะครับ\n\nกล่องทุกใบมีหน้าที่มาเป็นคู่เสมอ — บนคู่กับล่าง หน้าคู่กับหลัง ซ้ายคู่กับขวา\n\nเวลาห่อของขวัญจริงๆ เราก็ต้องคลี่กระดาษให้ครอบทั้ง 3 คู่นี้ครับ"),
            ]
        ),
        ...
        new ScenarioDefinition(
            ...
            [
                new(1, 4,
                    Question: "ก่อนคำนวณ ลองนึกภาพก่อนนะครับ 🎯\n\nถ้าเราเปิดก๊อกน้ำเติมถัง — น้ำจะ 'เต็มถัง' เมื่อไร? อะไรคือสิ่งที่เรากำลังวัดอยู่?\n\nนั่นคือความหมายของ 'ปริมาตร' ครับ\nแล้วสูตรคำนวณปริมาตรทรงสี่เหลี่ยมมุมฉากคืออะไรครับ?",
                    ExpectedAnswer: "กว้างxยาวxสูง",
                    Hint: "ลองนึกถึงการหาพื้นที่ฐาน แล้วคูณความสูงครับ",
                    GuidedAssistance: "ไม่เป็นไรเลย! 💪 มาเริ่มด้วยกันนะครับ\n\nลองนึกภาพนี้: ถ้าเราวางลูกบาศก์ 1 ซม. เรียงตามความกว้าง ยาว และสูง\n• แถวแรก = กว้าง × ยาว ลูกบาศก์\n• ทุกชั้นรวมกัน = กว้าง × ยาว × สูง\n\nนั่นคือสูตรปริมาตรครับ!\nลองเขียนสูตรดูครับ: กว้าง × ? × ?",
                    WorkedExample: "ตัวอย่างการหาปริมาตร\n\nปริมาตร\n  = กว้าง × ยาว × สูง\n  = 50 × 100 × 80\n  = 400,000 ลบ.ซม.\n\nลองพิมพ์สูตรให้ถูกต้องดูครับ",
                    IsLast: false,
                    PassiveGrill: "🧠 ก่อนทำโจทย์ — ลองนึกภาพนี้ก่อนนะครับ\n\nถังน้ำกับตู้ปลาใช้สูตรเดิมทุกอย่าง — ปริมาตรคือ space ที่บรรจุของได้ ไม่ว่าจะเป็นน้ำ ปลา หรืออะไรก็ตาม\n\nสูตรเดียวใช้ได้กับทุกทรงสี่เหลี่ยมมุมฉากในโลกครับ"),
                new(2, 4,
                    ...
                    IsLast: false,
                    TeachingMoment: "🎯 เทคนิคคิดเร็ว: คูณตัวเลขหลักก่อน (5×1=5) แล้วนับศูนย์ทั้งหมดแล้วเติมตามครับ\nจาก 50 มีศูนย์ 1 ตัว, จาก 100 มีศูนย์ 2 ตัว รวม 3 ตัวครับ",
                    TechniqueType: "mental_math",
                    PassiveGrill: "🧠 ก่อนทำโจทย์ — ลองนึกทางลัดนี้ก่อนนะครับ\n\n50 คือครึ่งหนึ่งของ 100\nดังนั้น 50×100 ก็คือครึ่งหนึ่งของ 100×100\n\n100×100 = 10,000 → ครึ่งหนึ่ง = 5,000 ครับ"),
                new(3, 4,
                    ...
                    IsLast: false,
                    TeachingMoment: "🎯 เห็นรูปแบบเดิมไหมครับ — 5×8=40 แล้วนับศูนย์รวม 4 ตัว = 400,000\nยิ่งฝึกเทคนิคนี้ ยิ่งคำนวณได้เร็วขึ้นเรื่อยๆ ครับ!",
                    TechniqueType: "pattern_recognition",
                    PassiveGrill: "🧠 ก่อนทำโจทย์ — สังเกตรูปแบบเดิมนะครับ\n\n5,000×80 ใช้เทคนิคเดิม — คูณตัวเลขหลักก่อน (5×8=40) แล้วนับศูนย์\n\nสังเกตว่าตัวเลขยิ่งใหญ่ขึ้น เทคนิคยิ่งมีประโยชน์ เพราะ 5×8 ยังคำนวณในหัวได้ครับ"),
                new(4, 4,
                    ...
                    IsLast: true,
                    PassiveGrill: "🧠 ก่อนทำโจทย์ — ลองนึกถึงขนาดจริงนะครับ\n\n400 ลิตร มากแค่ไหน?\nครอบครัว 4 คน ใช้น้ำกินวันละประมาณ 10 ลิตร — ถังนี้เก็บน้ำได้ประมาณ 40 วัน\n\nปริมาตรเชื่อมกับการวางแผนชีวิตจริงมากกว่าที่คิดครับ"),
            ]
        ),
    ];
}
