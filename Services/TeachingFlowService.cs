...
public class TeachingFlowService(AppDbContext db, IChatProvider chat)
{
    ...
    private const string StepPlanPrompt = """
        ...
        - แต่ละขั้นต้องถามหา "คำตอบเดียวชัดๆ" ที่นักเรียนชี้หรือคำนวณได้ในก้าวเดียว
          ❌ ห้ามคำถามกว้างเชิงกลยุทธ์ที่ต้องรู้วิธีแก้ทั้งโจทย์ก่อนถึงตอบได้ เช่น "แบ่ง...ได้อย่างไรบ้าง" "มีวิธีไหนบ้าง" "จะจัดการอย่างไร"
          ✅ ถามเจาะจงทีละก้าว เช่น "ตัวเลข 8 กับ 4 หารกันได้เท่าไร?" "n⁵ ÷ n⁻⁷ ใช้สมบัติเลขยกกำลังข้อไหน?"
